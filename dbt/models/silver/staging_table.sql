...
trades AS (
  SELECT
    ...
    {{ requests_completed('STATUS_NAME') }} AS completed,
    {{ requests_draft('STATUS_NAME') }} AS draft,
    {{ requests_awaiting_payment('STATUS_NAME') }} AS awaiting_payment,
    {{ requests_in_progress_baladi('STATUS_NAME') }} AS in_progress_baladi,
    {{ requests_in_progress_external('STATUS_NAME') }} AS in_progress_external,
    {{ requests_returned_to_user('STATUS_NAME') }} AS returned_to_user,
    {{ detect_vip_customers('TRADE_NAME') }} AS vip
  FROM {{ ref('commercial') }}
),
...
constructions AS (
  SELECT
    ...
    {{ requests_completed('REQUEST_STATUS_DESC') }} AS completed,
    {{ requests_draft('REQUEST_STATUS_DESC') }} AS draft,
    {{ requests_awaiting_payment('REQUEST_STATUS_DESC') }} AS awaiting_payment,
    {{ requests_in_progress_baladi('REQUEST_STATUS_DESC') }} AS in_progress_baladi,
    {{ requests_in_progress_external('REQUEST_STATUS_DESC') }} AS in_progress_external,
    {{ requests_returned_to_user('REQUEST_STATUS_DESC') }} AS returned_to_user,
    FALSE as vip
  FROM {{ ref('construction') }}
),
...
areas AS (
  SELECT
    ...
    'غير فوري' AS STATUS_FAWRY,
    {{ requests_completed('V_R_STATUS') }} AS completed,
    {{ requests_draft('V_R_STATUS') }} AS draft,
    {{ requests_awaiting_payment('V_R_STATUS') }} AS awaiting_payment,
    {{ requests_in_progress_baladi('V_R_STATUS') }} AS in_progress_baladi,
    {{ requests_in_progress_external('V_R_STATUS') }} AS in_progress_external,
    {{ requests_returned_to_user('V_R_STATUS') }} AS returned_to_user,
...
audits AS (
  SELECT
    ...
    -- email,
    'غير فوري' AS STATUS_FAWRY,
    {{ requests_completed('observation_status_name') }} AS completed,
    {{ requests_draft('observation_status_name') }} AS draft,
    {{ requests_awaiting_payment('observation_status_name') }} AS awaiting_payment,
    {{ requests_in_progress_baladi('observation_status_name') }} AS in_progress_baladi,
    {{ requests_in_progress_external('observation_status_name') }} AS in_progress_external,
    {{ requests_returned_to_user('observation_status_name') }} AS returned_to_user,
    FALSE as vip
  FROM {{ ref('audit') }}
)
